    ...
    <div class="container">
        ...
        <div class="about-boxes">
            <div class="row">
                <div class="col-lg-5">
                    <div class="about-img">
                        <img src="assets/img/my_new1.jpg" alt="supun nanayakkara">
                ...
                <div class="col-lg-7">
                    <div class="about-description">
                        ...
                        <p class="about-text">Hello guys! I'm Supun Nanayakkara. I am fascinated by how computer technology has brought changes to our
                            ...
                            has perpetually developed since this time.</p>
                    </div>
                    <!-- Personal Info -->
                    <div class="row">
                        <div class="col-lg-6">
        ...
        <div id="count-up" class="count-up text-center box-border">
            <div class="row">
                ...
                <div class="col-6 col-lg-3 my-4 count-item">
                    ...
                    <span class="timer count-number" data-from="0" data-to="70" data-speed="5000">0</span>
                    <p class="mb-0">Application Development</p>
                </div>
                <!-- Item-02 -->
                <div class="col-6 col-lg-3 my-4 count-item">
                    <div class="count-icon">
                    ...
                    <span class="timer count-number" data-from="0" data-to="30" data-speed="5000">0</span>
                ...
                <div class="col-6 col-lg-3 my-4 count-item">
                    ...
                    <span class="timer count-number" data-from="0" data-to="200" data-speed="5000">0</span>
                ...
                <div class="col-6 col-lg-3 my-4 count-item">
                    ...
                    <span class="timer count-number" data-from="0" data-to="100" data-speed="5000">0</span>
        ...
        <div class="row mt-5 skills">
            <div class="col-lg-6">
                <h3 class="subtitle">Programming Skills</h3>
                <div id="skills">
                    <!-- Item 01 -->
            ...
            <div class="col-lg-5 ms-auto mt-5 mt-lg-0">
                <h3 class="subtitle">Database Skills</h3>
