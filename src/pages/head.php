<head>
    ...
    <meta name="description" content="Hello guys! I'm Supun Nanayakkara. I am fascinated by how computer technology has brought changes to our
                            ...
                            has perpetually developed since this time." />
    <meta name="keywords" content="Supun Nanayakkara, Supun, Ebats Technologies, Software Engineer, IT,
                            Supun Nanayakkara Software Engineer, Senior Software Engineer, supun nanayakkara,
                            Supun Srilanka, Traditionalme, traditionalme.life, union assurance plc, union assurance,
                            union assurance supun" />
    <meta name="author" content="Supun Nanayakkara" />
    <!--  FavIcon  -->
    <link rel="shortcut icon" href="assets/img/app-logo.png">
    ...
    <!--  Color Css  -->
    <link rel="stylesheet" href="assets/colors/golden.css" id="option-color">
</head>
